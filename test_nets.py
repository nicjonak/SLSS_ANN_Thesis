...
class recovery_net(nn.Module):
    def __init__(self):
        ...
        self.sx_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.sympdurat_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.married_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.education_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.smoke_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.exercise_embed = nn.Sequential(nn.Embedding(4, 3, padding_idx=0), nn.Linear(3, 1))
        self.workstat_embed = nn.Sequential(nn.Embedding(4, 3, padding_idx=0), nn.Linear(3, 1))
        self.chiroN_embed = nn.Sequential(nn.Embedding(5, 3, padding_idx=0), nn.Linear(3, 1))
        self.physioN_embed = nn.Sequential(nn.Embedding(5, 3, padding_idx=0), nn.Linear(3, 1))
        self.trainer_embed = nn.Sequential(nn.Embedding(5, 3, padding_idx=0), nn.Linear(3, 1))
        self.painmed_embed = nn.Sequential(nn.Embedding(5, 3, padding_idx=0), nn.Linear(3, 1))
        self.inflammatory_embed = nn.Sequential(nn.Embedding(5, 3, padding_idx=0), nn.Linear(3, 1))
        self.musclerelax_embed = nn.Sequential(nn.Embedding(5, 3, padding_idx=0), nn.Linear(3, 1))
        self.ECbackpain_embed = nn.Sequential(nn.Embedding(6, 3, padding_idx=0), nn.Linear(3, 1))
        self.EClegpain_embed = nn.Sequential(nn.Embedding(6, 3, padding_idx=0), nn.Linear(3, 1))
        self.ECindependence_embed = nn.Sequential(nn.Embedding(6, 3, padding_idx=0), nn.Linear(3, 1))
        self.ECsportsac_embed = nn.Sequential(nn.Embedding(6, 3, padding_idx=0), nn.Linear(3, 1))
        self.ECphyscapac_embed = nn.Sequential(nn.Embedding(6, 3, padding_idx=0), nn.Linear(3, 1))
        self.ECsocial_embed = nn.Sequential(nn.Embedding(6, 3, padding_idx=0), nn.Linear(3, 1))
        self.ECwellbeing_embed = nn.Sequential(nn.Embedding(6, 3, padding_idx=0), nn.Linear(3, 1))
        self.expbackpain_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.explegpain_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.expindependence_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.expsports_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.expphyscap_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.expsocial_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.expwellbeing_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.chiro_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
        self.physio_embed = nn.Sequential(nn.Embedding(3, 3, padding_idx=0), nn.Linear(3, 1))
