...
class recovery_net(nn.Module):
    def __init__(self):
        ...
        self.painmed_embed = nn.Sequential(nn.Embedding(3, 6), nn.Linear(6, 6), nn.ReLU(), nn.Linear(6,1))
        self.inflammatory_embed = nn.Sequential(nn.Embedding(3, 6), nn.Linear(6, 6), nn.ReLU(), nn.Linear(6,1))
        self.musclerelax_embed = nn.Sequential(nn.Embedding(3, 6), nn.Linear(6, 6), nn.ReLU(), nn.Linear(6,1))
        self.ECbackpain_embed = nn.Sequential(nn.Embedding(4, 6), nn.Linear(6, 6), nn.ReLU(), nn.Linear(6,1))
        self.EClegpain_embed = nn.Sequential(nn.Embedding(4, 6), nn.Linear(6, 6), nn.ReLU(), nn.Linear(6,1))
        self.ECindependence_embed = nn.Sequential(nn.Embedding(4, 6), nn.Linear(6, 6), nn.ReLU(), nn.Linear(6,1))
        self.ECsportsac_embed = nn.Sequential(nn.Embedding(4, 6), nn.Linear(6, 6), nn.ReLU(), nn.Linear(6,1))
        self.ECphyscapac_embed = nn.Sequential(nn.Embedding(4, 6), nn.Linear(6, 6), nn.ReLU(), nn.Linear(6,1))
        self.ECsocial_embed = nn.Sequential(nn.Embedding(4, 6), nn.Linear(6, 6), nn.ReLU(), nn.Linear(6,1))
        self.ECwellbeing_embed = nn.Sequential(nn.Embedding(4, 6), nn.Linear(6, 6), nn.ReLU(), nn.Linear(6,1))
