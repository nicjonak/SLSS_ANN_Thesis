...
class recovery_net(nn.Module):
    def __init__(self):
        ...
        self.married_embed = nn.Sequential(nn.Embedding(2, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.education_embed = nn.Sequential(nn.Embedding(2, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.smoke_embed = nn.Sequential(nn.Embedding(2, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.exercise_embed = nn.Sequential(nn.Embedding(3, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.workstat_embed = nn.Sequential(nn.Embedding(3, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.chiroN_embed = nn.Sequential(nn.Embedding(4, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.physioN_embed = nn.Sequential(nn.Embedding(4, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.trainer_embed = nn.Sequential(nn.Embedding(4, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.painmed_embed = nn.Sequential(nn.Embedding(3, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.inflammatory_embed = nn.Sequential(nn.Embedding(3, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.musclerelax_embed = nn.Sequential(nn.Embedding(3, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.ECbackpain_embed = nn.Sequential(nn.Embedding(4, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.EClegpain_embed = nn.Sequential(nn.Embedding(4, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.ECindependence_embed = nn.Sequential(nn.Embedding(4, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.ECsportsac_embed = nn.Sequential(nn.Embedding(4, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.ECphyscapac_embed = nn.Sequential(nn.Embedding(4, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.ECsocial_embed = nn.Sequential(nn.Embedding(4, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.ECwellbeing_embed = nn.Sequential(nn.Embedding(4, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.expbackpain_embed = nn.Sequential(nn.Embedding(2, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.explegpain_embed = nn.Sequential(nn.Embedding(2, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.expindependence_embed = nn.Sequential(nn.Embedding(2, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.expsports_embed = nn.Sequential(nn.Embedding(2, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.expphyscap_embed = nn.Sequential(nn.Embedding(2, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.expsocial_embed = nn.Sequential(nn.Embedding(2, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
        self.expwellbeing_embed = nn.Sequential(nn.Embedding(2, 12), nn.Linear(12, 12), nn.ReLU(), nn.Linear(12,1))
